...
/********************************
#define HVAC_MITSUBISHI_HDR_MARK    3450
#define HVAC_MITSUBISHI_HDR_SPACE   1720
...
void IRsend::sendHvacMitsubishi( )
{
  ...
  if (HVACTemperature > 31) {
    Temp = 31;
  }
  else if (HVACTemperature < 16) {
    Temp = 16;
  }
  else {
    Temp = HVACTemperature;
  };
  data[7] = (byte) Temp - 16;

  enum HvacMitsubishiFanMode {
    FAN_SPEED_1,
    FAN_SPEED_2,
    FAN_SPEED_3,
    FAN_SPEED_4,
